...
-   **Gaming Cafe Project (2025-10-03)**: Next.js 15 + TypeScript + Tailwind CSS, Thai language support, client-side state management with React hooks
-   **Always ask about templates first** - Before creating documentation, ask if there's a preferred template or pattern to follow (2025-10-03)
...
-   **Strict GitHub Flow adherence** - Always branch → commit → push → PR, never commit directly to main (2025-10-03)
-   **Teaching by demonstration** - Shows what not to do first, then establishes the rule (2025-10-03)
